...
- Le package partage `@axelys/legal` est consomme depuis son build compile et doit etre explicitement inclus dans le bundle Vercel de l'API via `functions.includeFiles = node_modules/@axelys/legal/**` pour eviter les erreurs runtime `Cannot find module '@axelys/legal'`
